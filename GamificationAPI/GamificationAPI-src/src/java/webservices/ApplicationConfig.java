...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(webservices.ActionResource.class);
        resources.add(webservices.ActionsResource.class);
        resources.add(webservices.ApplicationResource.class);
        resources.add(webservices.ApplicationsResource.class);
        ...
        resources.add(webservices.EventTypeResource.class);
        resources.add(webservices.EventTypesResource.class);
        resources.add(webservices.EventsResource.class);
        resources.add(webservices.ObjectTypeResource.class);
        resources.add(webservices.ObjectTypesResource.class);
        ...
        resources.add(webservices.TeamRoleResource.class);
        resources.add(webservices.TeamRolesResource.class);
