 ...
 */
public class Privilege  implements java.io.Serializable, JSONable {
    ...
    public Privilege(Reward reward) {
        this.reward = reward;
    }
    public Privilege(Reward reward, String icon) {
       this.reward = reward;
       this.icon = icon;
    }
    ...
    public JSONObject toJSON() {
        ...
        try {
            ...
            System.out.println("Error Privilege-toJSON: " + ex.getMessage());
        }
        return obj;
    }
    ...
    public void fromJSON(JSONObject obj) {
        try {
            ...
            System.out.println("Error in Privilege-fromJson: " + ex.getMessage());
        }
    }
