 ...
 */
public class EventType  implements java.io.Serializable, JSONable {
    ...
    public EventType(Application application, String name, String description) {
        this.application = application;
        this.name = name;
        this.description = description;
    }
    public EventType(Application application, String name, String description, Set<Event> events, Set<Action> actions) {
       this.application = application;
       this.name = name;
       this.description = description;
       this.events = events;
