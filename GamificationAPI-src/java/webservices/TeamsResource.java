...
public class TeamsResource {
    ...
    /**
     * Retrieves representation of an instance of webservices.TeamsResource
     *
     ...
     */
    @Path("{id}")
    public TeamResource getTeamResource(@PathParam("id") String id) {
        return TeamResource.getInstance(id);
    }
}
